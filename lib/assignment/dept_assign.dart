...
import 'package:teacheralpine/assignment/sem_assign.dart';
import 'package:teacheralpine/model/department.dart';

class dept_assign_page extends StatefulWidget {
  @override
  _dept_assign_pageState createState() => _dept_assign_pageState();
}

class _dept_assign_pageState extends State<dept_assign_page> {
    ...
    ListTile makeListTile(Department department) => ListTile(
      ...
      onTap: (){
        ...
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => sem_assign_screen(dept)));
      },
    );
