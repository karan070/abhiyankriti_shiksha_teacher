...
class dept_attpage extends StatefulWidget {
  @override
  _dept_attpageState createState() => _dept_attpageState();
}

class _dept_attpageState extends State<dept_attpage> {
  ...
  Widget build(BuildContext context) {
    ListTile makeListTile(Department department) => ListTile(
      ...
      onTap: (){
        Navigator.of(context).pushNamed('/sem_att');
      },
    );
