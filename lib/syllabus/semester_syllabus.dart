...
class sem_screen_syllabus extends StatefulWidget {

  final String dept;
  sem_screen_syllabus(this.dept , {Key key}) : super(key: key);

  @override
  _sem_screen_syllabusState createState() => _sem_screen_syllabusState();
}

class _sem_screen_syllabusState extends State<sem_screen_syllabus> {
        ...
        ListTile(
          ...
          onTap: () {
            ...
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => upload_syllabus(Dept , semesterr)));
          },
        );
