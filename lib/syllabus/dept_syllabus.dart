...
class dept_syl_page extends StatefulWidget {
  @override
  _dept_syl_pageState createState() => _dept_syl_pageState();
}

class _dept_syl_pageState extends State<dept_syl_page> {
    ...
    ListTile makeListTile(Department department) => ListTile(
      ...
      onTap: (){
        ...
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => sem_screen_syllabus(dept)));
      },
    );
